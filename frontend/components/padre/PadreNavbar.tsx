...
export function PadreNavbar() {
  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
      <div className="max-w-5xl mx-auto px-2 sm:px-4 min-h-11 py-1.5 sm:py-0 flex items-center justify-between gap-2 sm:gap-4 flex-wrap sm:flex-nowrap">
        {/* Logo */}
        ...
        {/* Nav items */}
        <nav className="flex items-center gap-0.5 sm:gap-1 text-[9px] sm:text-[11px] font-semibold text-gray-500 uppercase tracking-wide flex-wrap justify-end">
          <button className="px-1 sm:px-2 py-1 hover:text-gray-800 flex items-center gap-0.5 sm:gap-1 rounded hover:bg-gray-50 transition-colors">
          ...
          <Link
            href="/app/perfil"
            className="px-1 sm:px-2 py-1 hover:text-gray-800 flex items-center gap-0.5 sm:gap-1 rounded hover:bg-gray-50 transition-colors"
          >
