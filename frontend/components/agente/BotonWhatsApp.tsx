...
export function BotonWhatsApp({ telefono, mensaje, label = 'WhatsApp', className = '' }: BotonWhatsAppProps) {
  ...
  return (
      ...
      className={`inline-flex items-center gap-2 bg-green-500 text-white px-3 py-1.5 rounded-lg text-xs font-medium hover:bg-green-600 transition-colors ${className}`}
    >
